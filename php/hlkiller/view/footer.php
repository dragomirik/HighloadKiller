<script type="text/javascript">
  $(function(){
	...
	$('.gen_fish').on('click', function() {
			...
			$.get('/hlkiller/index.php?do=generate_fish', function(data){
	...
	$('.clear_db').on('click', function() {
			...
			$.get('/hlkiller/index.php?do=clear_db', function(data){
	...
	$('.max_select_attack').on('click', function() {
		...
		$.get('/hlkiller/index.php?do=make_select_attack', function(data){
